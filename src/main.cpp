...
int main(int argc, char *argv[])
{
	...
	polling_msg[0].cb = cb_create(path_0,11);//2KB
	polling_msg[1].cb = cb_create(path_1,9);//512Byte
	polling_msg[2].cb = cb_create(path_2,9);
	polling_msg[3].cb = cb_create(path_3,9);
	polling_msg[4].cb = cb_create(path_4,9);
	polling_msg[5].cb = cb_create(path_5,9);
	polling_msg[6].cb = cb_create(path_6,9);
	polling_msg[7].cb = cb_create(path_7,9);
	polling_msg[8].cb = cb_create(path_8,9);
	polling_msg[9].cb = cb_create(path_9,9);
	polling_msg[10].cb = cb_create(path_10,9);
#else
	polling_msg[0].cb = cb_create(NULL,11);//2KB
	polling_msg[1].cb = cb_create(NULL,9);//512Byte
	polling_msg[2].cb = cb_create(NULL,9);
	polling_msg[3].cb = cb_create(NULL,9);
	polling_msg[4].cb = cb_create(NULL,9);
	polling_msg[5].cb = cb_create(NULL,9);
	polling_msg[6].cb = cb_create(NULL,9);
	polling_msg[7].cb = cb_create(NULL,9);
	polling_msg[8].cb = cb_create(NULL,9);
	polling_msg[9].cb = cb_create(NULL,9);
	polling_msg[10].cb = cb_create(NULL,9);
#endif

    /*建立线程*/
	pthread_opt_user pthread_user_seq[] =
	{
		{modbus_slave_decode_start, polling_msg[0].cb},
		{usart_rx_start,  polling_msg[1].cb},
		{usart_rx_start,  polling_msg[2].cb},
		{usart_rx_start,  polling_msg[3].cb},
		{usart_rx_start,  polling_msg[4].cb},
		{usart_rx_start,  polling_msg[5].cb},
		{usart_rx_start,  polling_msg[6].cb},
		{usart_rx_start,  polling_msg[7].cb},
		{usart_rx_start,  polling_msg[8].cb},
		{usart_rx_start,  polling_msg[9].cb},
		{usart_rx_start, polling_msg[10].cb},
